...
[master]
master ansible_host=$MASTER_IP ansible_user=adamalhafizh23 ansible_ssh_private_key_file=~/.ssh/id_rsa

[db]
db ansible_host=$DB_IP ansible_user=adamalhafizh23 ansible_ssh_private_key_file=~/.ssh/id_rsa

[monitoring]
monitoring ansible_host=$MONITORING_IP ansible_user=adamalhafizh23 ansible_ssh_private_key_file=~/.ssh/id_rsa

[worker]
worker ansible_host=$WORKER1_IP ansible_user=adamalhafizh23 ansible_ssh_private_key_file=~/.ssh/id_rsa
